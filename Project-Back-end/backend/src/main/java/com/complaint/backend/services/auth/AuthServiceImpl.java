...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    public UserDTO signup(SignupRequest signupRequest, UserRole role) {
    if (role == UserRole.ADMIN) {
        throw new IllegalArgumentException("Cannot signup as ADMIN");
    }
    ...
    user.setEmail(signupRequest.getEmail());
    user.setName(signupRequest.getName());
    user.setAddress(signupRequest.getAddress()); // Map address
